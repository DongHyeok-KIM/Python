...
class Detect:
    ...
    def next_batch(num, data, labels):
        ...
        return np.asarray(data_shuffle), np.asanyarray(labels_shuffle)

    @staticmethod
    def build_CNN_classfier(x):  # wx +b
        # 입력이미지
        x_image = x
...
dec = Detect()
y_pred, logits = dec.build_CNN_classfier(x)
